...
Correlation	| 1, Time riders spent with low hands positions | Categorical | 1, Number of horses with high, round, or hollow neck position| Categorical | 1, Riders' rein length<br> 2, Riders' heel height | 1, categorical 2, categorical |	Number of horses with high, round, or hollow neck position when riders spent more time with low hands positions is significantly higher than the control group | Number of horses of test group <= Number of control group | 0.01 | [Human Direct Actions May Alter Animal Welfare, a Study on Horses (Equus caballus)](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0010257) |
